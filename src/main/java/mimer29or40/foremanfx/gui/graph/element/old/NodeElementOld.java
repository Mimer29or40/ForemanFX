...
public class NodeElementOld extends GraphElementOld
{
    ...
    private AssemblerBoxOld assemblerBox;
...
//    private StringFormat centreFormat = new StringFormat();
    ...
    public NodeElementOld(ProductionNode node, ProductionGraphPaneOld parent)
    {
        super(parent);
        width = 100;
        height = 90;
...
//                {
//                    tti.Text += String.Format("\n----{0} ({1})", kvp.Key.entity.FriendlyName,
// kvp.Value.ToString());
