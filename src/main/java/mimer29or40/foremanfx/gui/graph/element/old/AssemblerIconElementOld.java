...
public class AssemblerIconElementOld extends GraphElementOld
{
    ...
    public AssemblerIconElementOld(MachinePermutation assembler, int displayedNumber, ProductionGraphPaneOld parent)
    {
        super(parent);
...
//        centreFormat.Alignment = centreFormat.LineAlignment = StringAlignment.Center;
    ...
    public void paint(GraphicsContext graphics)
    {
        ...
        graphics.drawImage(displayedMachine.entity.icon, iconPoint.getX(), iconPoint.getY(), iconSize, iconSize);
